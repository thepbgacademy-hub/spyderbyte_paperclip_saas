...
- deepen the worker-side harness seam from “bounded lane-dispatch payload” into a real orchestrator/child execution handoff only after the current single-lane selection rules and continuity-backed resume focus stay stable under review
