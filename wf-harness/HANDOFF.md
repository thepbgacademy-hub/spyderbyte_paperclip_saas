...
- decide whether the current bounded lane-continuity snapshot needs one more operational field for resume focus, or whether absorbed work plus latest outcome are enough before any Obsidian/export layer is introduced
