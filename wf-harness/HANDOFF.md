...
- consume the new worker `postOutcomeAction` seam inside the orchestrator/runtime handoff so dispatch-vs-review-vs-wait decisions travel as explicit engine truth instead of being reconstructed from `nextDispatch` or run-state guesses
